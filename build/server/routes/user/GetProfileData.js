...
import { getUserBadges } from './GetBadges.js';
...
const getUserProfileData = async (steamId, dataLimit) => {
    try {
        const profileData = {
            ownedGames: {},
            recentGames: {},
        ...
        ].slice(0, dataLimit > 0 ? dataLimit : undefined).filter((id) => Number.isInteger(id) && !NOT_EXISTING_APP_IDS.includes(Number(id)));
        ...
        //tags
        profileData.tags = await getTags();
        //steamLvl and badges
